    ...
    <div className='bg-slate-700 m-0 min-h-[90vh]'>
        ...
        <div className='  md:w-[80%] h-auto min-h-[70vh] m-auto text-white'>
          ...
          <div className=''>
            ...
            <div className='flex flex-col  items-end justify-center m-3 ' ><input type="text" className='py-1 px-3 text-black'  placeholder='your address' value={liveLocation}/> <button onClick={getLocation} className='hover:bg-green-600 transistion-all duration-500 py-1 px-5 my-3 bg-green-700   rounded-2xl font-bold'>live location</button> </div>
